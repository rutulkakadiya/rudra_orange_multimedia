        ...
        <div className="h-full pt-8 pb-8 lg:pt-10 lg:pb-10 lg:border-r border-b lg:border-b-0 border-white/5">
            <div className="pb-8 lg:pb-10 text-center lg:text-left px-6">
                ...
                <h2 className="text-4xl font-semibold leading-tight mb-4">
                    Other <span className="text-(--first)">Pages</span>
                </h2>
            ...
            <div className="grid grid-cols-2">
                {branches.map((branch, i) => (
                    <a
                        key={i}
                        href={`https://www.instagram.com/${branch}`}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="group p-6 border border-white/5 transition-all duration-300 text-center block hover:bg-white/5"
                    >
