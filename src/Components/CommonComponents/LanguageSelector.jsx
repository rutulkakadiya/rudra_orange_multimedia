  ...
  return (
    <div className="relative language-selector-container">
      ...
      <button
        ...
        className=" px-6 py-2 rounded-full text-white cursor-pointer transition flex justify-between items-center"
      >
       <span className="flex items-center pe-2 md: " > Select </span> <LuLanguages/> <BiChevronDown size={22} />
      </button>
  
      {/* Dropdown List */}
      {isOpen && (
        <div className=" absolute z-100 mt-2 bg-black w-[150px] backdrop-blur-md  shadow-lg overflow-hidden  rounded-md max-h-[320px] flex flex-col right-0 ">
          {/* Search Bar */}
          {/* <div className="p-2 sticky top-0 bg-white/0 backdrop-blur-2xl">
            <div className="relative">
              <input
                ...
                className="w-full pl-8 pr-2 py-2 rounded-md focus:outline-none focus:ring-1 focus:ring-black text-gray-800"
              />
            ...
            {filteredLanguages.length > 0 ? (
              filteredLanguages.map((lang) => (
                <div
                  ...
                  className="px-4 py-2 hover:bg-(--first)  text-center text-white cursor-pointer transition"
                >
                  {lang.name}
                </div>
              ))
